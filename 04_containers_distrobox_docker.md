...
## 🔗 Notas Relacionadas
- [Omarchy: Pós-instalação](02_omarchy_pos_instalacao.md) — Setup de desenvolvimento do Omarchy.
- [Virt-Manager & Hipervisor KVM](05_virtualizacao_virt_manager.md) — Comparativo entre virtualização e containers.
